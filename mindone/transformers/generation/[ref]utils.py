...
from transformers.candidate_generator import (
...
class GenerationMixin:
    ...
    ) -> Tuple[ms.Tensor, Dict[str, torch.Tensor]]:
    ...
    def compute_transition_scores(
        ...
        beam_indices = beam_indices.coyp()[:, :max_beam_length]
        ...
        **model_kwargs,
        ...
        while self._has_unfinished_sequences(this_peer_finished, synced_gpus, device=input_ids.device):
            ...
            for beam_group_idx in range(num_beam_groups):
                ...
                # No need to copy() the logits here as they will not retain outputs.logits at the end of the loop
                # .float() is needed to retain precision for later logits manipulations
