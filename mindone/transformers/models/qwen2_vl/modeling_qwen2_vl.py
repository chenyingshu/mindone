...
import numpy as np
_MAX_FP16 = ms.tensor(np.finfo(np.float16).min, dtype=ms.float16)
_MAX_FP32 = ms.tensor(np.finfo(np.float32).min, dtype=ms.float32)
...
def repeat_kv(hidden_states: ms.Tensor, n_rep: int) -> ms.Tensor:
    ...
    #https://www.mindspore.cn/docs/zh-CN/r2.3.1/note/api_mapping/pytorch_diff/expand.html
...
class Qwen2VLForConditionalGeneration(Qwen2VLPreTrainedModel, GenerationMixin): # TODO: GenerationMixin
    ...
    def _update_model_kwargs_for_generation(
        ...
        model_kwargs = super()._update_model_kwargs_for_generation( # TODO
            outputs=outputs,
    ...
    def construct(
        ...
        attention_mask: Optional[ms.Tensor] = None,
        position_ids: Optional[ms.Tensor] = None, #Long
        past_key_values: Optional[List[ms.Tensor]] = None, #Float
        inputs_embeds: Optional[ms.Tensor] = None, #Float
        labels: Optional[ms.Tensor] = None, #Long
        use_cache: Optional[bool] = None,
        output_attentions: Optional[bool] = None,
        output_hidden_states: Optional[bool] = None,
        return_dict: Optional[bool] = None,
        pixel_values: Optional[ms.Tensor] = None,
        pixel_values_videos: Optional[ms.Tensor] = None, #Float
        image_grid_thw: Optional[ms.Tensor] = None, #Long
        video_grid_thw: Optional[ms.Tensor] = None, #Long
